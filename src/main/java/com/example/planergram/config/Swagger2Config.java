...
public class Swagger2Config {
    private static final String API_NAME = "플래너그램 API";
    private static final String API_VERSION = "1.0";
    private static final String API_DESCRIPTION = "플래너그램 서버 API 문서";
    ...
    public Docket api() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .ignoredParameterTypes(AuthenticationPrincipal.class) //제외할 파라미터
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.example.planergram")) // Swagger를 적용할 package명 작성
