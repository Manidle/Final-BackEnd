...
//    public ResponseEntity<?> update(@PathVariable int id, @RequestBody PostDTO updatePostDTO) {
//        Post post = postService.update(id, updatePostDTO);
//        PostDTO postDTO = postService.makePostDTO(post);
//        return postService.update(id, post);
//    }

    //게시글 업데이트
    @PutMapping("/post/update/{id}")
    public ResponseEntity<?> update(@PathVariable("id") int id,@RequestBody PostDTO updatePostDTO) {
        try {
